...
hitung.addEventListener("click", () => {
    ...
    if (!usia || !gender || !beratBadan || !tinggiBadan)
        // Peringatan
        {
            alert("Silakan isi semua input (gender, usia, berat badan, dan tinggi badan) sebelum menghitung BMI.");
        return;
        }
    ...
    if (bmi < 18.5) {
        ...
        resultText.innerHTML = "Berat Badan Anda Kurang ☹";
        resultKetNumber.innerHTML = "Hasil BMI Anda kurang dari 18.5";
        resultKetText.innerHTML = `Anda seorang ${gender} dengan umur ${usia} Tahun, saat ini Anda berada dalam kategori kekurangan berat badan. Anda harus meningkatkan berat badan sebaik mungkin.`;
        ...
        resultNumber.innerHTML = bmi.toFixed(2);
        resultText.innerHTML = "Berat Badan Anda Normal atau Ideal 😊";
        resultKetNumber.innerHTML = "Hasil BMI Anda berada diantara 18.5 dan 24.9";
        resultKetText.innerHTML = `Anda seorang ${gender} dengan usia ${usia} Tahun, saat ini Anda berada dalam kategori yang Ideal. Tetap jaga pola makan dan gaya hidup sehat.`;
        resultKetSaran.innerHTML = "Menjaga pola makan yang seimbang, mengonsumsi makanan bergizi, dan melakukan aktivitas fisik secara teratur. Ini dapat  dilakukan agar Anda tetap sehat.";
        resultPenyakit.innerHTML = `Walaupun Berat Badan Anda Ideal alias Normal, Anda juga tetap berpotensi <br/> Kekurangan Berat Badan<br/> Kelebihan Berat Badan (Obesitas) <br/> Tekanan Darah Tinggi <br/> Apabila Anda tidak menjaga pola makan dan gaya hidup sehat.`;
    } else if (bmi >= 25.0 && bmi <= 29.9) {
        resultStatus.innerHTML = "Kelebihan Berat Badan";
        resultNumber.innerHTML = bmi.toFixed(2);
        resultText.innerHTML = "Anda memiliki berat badan lebih 🙁";
        resultKetNumber.innerHTML = "Hasil BMI Anda berada diantara 25.0 dan 29.9";
        resultKetText.innerHTML = `Anda seorang ${gender} dengan usia ${usia} Tahun, saat ini Anda berada dalam kategori kelebihan  berat badan. Anda dapat menurunkan berat badan agar Ideal`;
        ...
        resultNumber.innerHTML = bmi.toFixed(2);
        resultText.innerHTML = "Anda memiliki berat badan yang sangat berlebihan 😭";
        resultKetNumber.innerHTML = "Hasil BMI Anda berada diatas 30.0";
        resultKetText.innerHTML = `Anda seorang ${gender} dengan usia ${usia} Tahun, saat ini Anda berada dalam kategori Kegemukan / Obesitas . Anda harus segera menurunkan berat badan.`;
